...
exports.consultarStage = (req,res) => {
    ...
    if(!errors.isEmpty()){
        ...
        const sqlQry = "SELECT count(1) as 'Registros encontrados ' , DATE_FORMAT(min(date_), '%Y-%m-%d') as 'Data minima ', DATE_FORMAT(max(date_), '%Y-%m-%d') as 'Data maxima ' from CLOUD_EXTRATO;";
