...
exports.consultarStage = (req,res) => {
    ...
    if(!errors.isEmpty()){
        ...
        const sqlQry = "SELECT count(1) as 'Registros encontrados ' , min(DATE_FORMAT(date_, '%Y-%m-%d')) as 'Data minima ', max(DATE_FORMAT(date_, '%Y-%m-%d')) as 'Data maxima ' from CLOUD_EXTRATO;";
