...
exports.ReplicaDados = async (req,res)=>{
    ...
    if(!errors.isEmpty()){
        ...
        const retornoDelete = new Promise((resolve, reject)=>{
                ...
                const sqlQryD = 'delete from CLOUD_EXTRATO_HIST where vencimento_fatura = ? and valor_fatura = ? and date_ between (?) and (?);';
                    
            req.connection.query(sqlQryD,[vencimento_fatura,valor_fatura,data_inicio,data_fim],(err,result) => {
